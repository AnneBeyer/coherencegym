...
def _get_predictions_inner(sentence, tokenizer, model, device):
    # Copied from github.com/cpllab/lm-zoo/blob/master/models/transformers-base/get_surprisals.py
...
def get_surprisals(sentence, tokenizer, model, device):
    # Adapted from github.com/cpllab/lm-zoo/blob/master/models/transformers-base/get_surprisals.py
    # As this model handles dialogues, the separator token is used to mark a speaker change
    # in the input, this is indicated by the string "[SEP]"
...
def main(args):
    # (Mostly) copied from github.com/cpllab/lm-zoo/blob/master/models/transformers-base/get_surprisals.py
